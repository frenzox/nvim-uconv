...
function VolumeConversion.cubic_meters_to_cubic_inches(args)
    vim.cmd.normal(conversion.convert_with(function(cubic_meters)
...
function VolumeConversion.cubic_inches_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(cubic_inches)
...
function VolumeConversion.cubic_feet_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(cubic_feet)
...
function VolumeConversion.cubic_yards_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(cubic_yards)
...
function VolumeConversion.liters_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(liters)
        return liters * 0.001
    end, args))
end
...
function VolumeConversion.gallons_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(gallons)
...
function VolumeConversion.quarts_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(quarts)
...
function VolumeConversion.pints_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(pints)
...
function VolumeConversion.cups_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(cups)
...
function VolumeConversion.tablespoons_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(tablespoons)
...
function VolumeConversion.teaspoons_to_cubic_meters(args)
    vim.cmd.normal(conversion.convert_with(function(teaspoons)
