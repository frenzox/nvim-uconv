...
function TimeConversion.seconds_to_minutes(args)
    vim.cmd.normal(
        conversion.convert_with(function(seconds)
            return seconds / 60
        end, args)
    )
end
...
function TimeConversion.minutes_to_seconds(args)
    vim.cmd.normal(
        conversion.convert_with(function(minutes)
            return minutes * 60
        end, args)
    )
end
...
function TimeConversion.hours_to_seconds(args)
    vim.cmd.normal(
        conversion.convert_with(function(hours)
            return hours * 3600
        end, args)
    )
end
...
function TimeConversion.days_to_seconds(args)
    vim.cmd.normal(
        conversion.convert_with(function(days)
            return days * 86400
        end, args)
    )
end
...
function TimeConversion.weeks_to_seconds(args)
    vim.cmd.normal(
        conversion.convert_with(function(weeks)
            return weeks * 604800
        end, args)
    )
end
...
function TimeConversion.months_to_seconds(args)
    vim.cmd.normal(
        conversion.convert_with(function(months)
...
function TimeConversion.years_to_seconds(args)
    vim.cmd.normal(
        conversion.convert_with(function(years)
