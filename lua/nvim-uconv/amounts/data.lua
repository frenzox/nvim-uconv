...
function DataConversion.bytes_to_bits(args)
    vim.cmd.normal(
        conversion.convert_with(function(bytes)
            return bytes * 8
        end, args)
    )
end
...
function DataConversion.kilobytes_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(kilobytes)
...
function DataConversion.megabytes_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(megabytes)
...
function DataConversion.gigabytes_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(gigabytes)
...
function DataConversion.bits_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(bits)
            return bits / 8
        end, args)
    )
end
...
function DataConversion.terabytes_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(terabytes)
...
function DataConversion.petabytes_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(petabytes)
...
function DataConversion.exabytes_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(exabytes)
...
function DataConversion.zettabytes_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(zettabytes)
...
function DataConversion.yottabytes_to_bytes(args)
    vim.cmd.normal(
        conversion.convert_with(function(yottabytes)
