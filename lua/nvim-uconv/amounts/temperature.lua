...
function TemperatureConversion.kelvin_to_fahrenheit(args)
    vim.cmd.normal(conversion.convert_with(function(kelvin)
...
function TemperatureConversion.celsius_to_kelvin(args)
    vim.cmd.normal(conversion.convert_with(function(celsius)
...
function TemperatureConversion.fahrenheit_to_kelvin(args)
    vim.cmd.normal(conversion.convert_with(function(fahrenheit)
